...
public class JhExampleApp {

    private static final Logger log = LoggerFactory.getLogger(JhExampleApp.class);

    private final Environment env;

    public JhExampleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes JhExample.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhExampleApp.class);
